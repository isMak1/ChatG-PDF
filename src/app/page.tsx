...
export default async function Home() {
  ...
  return (
    <>
      <div className="flex w-[100%] h-screen bg-[#121212]">
        <div className="absolute md:right-[70px] overflow-hidden w-full max-h-screen ">
          <Canvas3D />
        </div>
        ...
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2">
          <div className="sparky flex gap-10 flex-col items-center text-center">
            <div className="flex items-center magic">
              <h1 className="drop-shadow-xl mr-3 xl:text-8xl text-3xl font-semibold animate-background-pan bg-gradient-to-bl from-violet-900 via-indigo-400 to-violet-900">AI PDF Chats</h1>
            </div>
